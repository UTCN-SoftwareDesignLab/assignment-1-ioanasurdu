...
public class Constants {
    ...
    public static class Rights {
        ...
        public static final String TRANSFER = "transfer_money";
        public static final String PROCESS_BILL = "process_bill";

        public static final String[] RIGHTS = new String[]{CREATE_USER, DELETE_USER, UPDATE_USER, VIEW_USERS, GENERATE_REPORT, ADD_CLIENT, UPDATE_CLIENT, VIEW_CLIENT, CREATE_ACCOUNT, UPDATE_ACCOUNT, DELETE_ACCOUNT, VIEW_ACCOUNT, TRANSFER, PROCESS_BILL};
    }
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(ADMINISTRATOR).addAll(Arrays.asList(CREATE_USER, DELETE_USER, UPDATE_USER, VIEW_USERS, GENERATE_REPORT));

        ROLES_RIGHTS.get(EMPLOYEE).addAll(Arrays.asList(ADD_CLIENT, UPDATE_CLIENT, VIEW_CLIENT, CREATE_ACCOUNT, UPDATE_ACCOUNT, DELETE_ACCOUNT, VIEW_ACCOUNT, TRANSFER, PROCESS_BILL));
